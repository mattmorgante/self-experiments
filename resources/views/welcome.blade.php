    ...
    <div id="left">
        <div class="container">
            ...
            <ul class="hero-bullets">
                ...
                <li class="list-disc">Self Experiments will text you everyday for 2-14 days to track your progress</li>
                <li class="list-disc">We will measure the outcomes and send you a summary at the end of the experiment</li>
                <li class="list-disc">You can find the correlation between changes and results, iterate and improve</li>
            </ul>
            <a href="/goals">
